...
public class ContaDAO {
	...
	private final String arquivo = "contas.txt";
	        private List<ContaCorrente> ccs = new ArrayList<>();
			public List<ContaCorrente> getCcs() {
				return ccs;
			}

			public void setCcs(List<ContaCorrente> ccs) {
				this.ccs = ccs;
			}

			private List<ContaPoupanca> cps = new ArrayList<>();
            public List<ContaPoupanca> getCps() {
				return cps;
			}

			public void setCps(List<ContaPoupanca> cps) {
				this.cps = cps;
			}
	...
	public void salvarConta() {
		...
		try  (BufferedWriter writer = new BufferedWriter(new FileWriter(arquivo))) {
			...
			for (ContaCorrente contaCorrente : getCcs()) {
			...
			for (ContaPoupanca contaPoupanca : getCps()) {
	...
	public void salvarContaCorrente(List<ContaCorrente>contas) {
	 ...
	 public void salvarContaPoupanca(List<ContaPoupanca>contas) {
